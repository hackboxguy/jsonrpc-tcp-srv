...
public:
  DispCtrlRpc(std::string rpcName, int myIndex, bool emu, bool log,
  ...
  int process_backlight_get(JsonDataCommObj *pReq,
  ...
  int process_backlight_set(JsonDataCommObj *pReq,
                            SYSMGR_CMN_DATA_CACHE *pData);
};
/* ------------------------------------------------------------------------- */
