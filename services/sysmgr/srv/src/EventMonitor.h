...
// 192.168.1.100 42513 13100 -1 DevOpChanged NetSttngChanged IdentStarted
// IdentFinished UpdateStarted UpdateFinished DiagFinished 192.168.1.101 42513
// 13101 -1 DevOpChanged NetSttngChanged IdentStarted IdentFinished
// UpdateStarted UpdateFinished DiagFinished 192.168.1.101 42512 12101 -1
// CaptureFinished CompareFinished 192.168.1.102 42512 12102 -1 CaptureFinished
// CompareFinished
...
public:
  EvntMonitEntry(string m_ip, int m_port, int m_srvToken, int m_evntType,
                 string str1 = "", string str2 = "", string str3 = "",
                 string str4 = "", string str5 = "", string str6 = "",
                 string str7 = "")
      : ip(m_ip), port(m_port), srvToken(m_srvToken), evntType(m_evntType) {
...
class FindMonitEntry {
  ...
  // int myEventType;
public:
  // FindMonitEntry(int m_srvToken,int
  // m_evntType):myToken(m_srvToken),myEventType(m_evntType){}
...
public:
  EventMonitor(std::string rpcName, int myIndex, bool emu, bool log,
  ...
  virtual void ReceiveEvent(int cltToken, int evntNum, int evntArg,
                            int evntArg2);
  RPC_SRV_RESULT LoadEventMonitList(std::string listFile,
