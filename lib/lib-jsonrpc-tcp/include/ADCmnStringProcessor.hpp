...
public:
  ...
  int convert_server_result_to_string(RPC_SRV_RESULT result,
                                      char *result_string);
  RPC_SRV_RESULT convert_string_to_server_result(char *result_string);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *result_para_name, char *result_para_value);
  ...
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, char *val1, char *name2, int val2,
                            char *name3, int val3, char *name4, int val4);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, char *val1, char *name2, char *val2,
  ...
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            ...
                            char *name5, char *val5);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, double val1, char *name2, double val2,
                            char *name3, double val3, char *name4, double val4,
                            char *name5, double val5, char *name6, double val6,
                            char *name7, double val7, char *name8, double val8,
  ...
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, char *val1, char *name2, char *val2,
                            char *name3, char *val3, char *name4, double val4,
                            char *name5, double val5, char *name6, double val6,
                            char *name7, double val7, char *name8, double val8,
                            char *name9, double val9, char *name10,
                            double val10, char *name11, double val11,
                            char *name12, double val12);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, int val1, char *name2, double val2,
                            char *name3, char *val3, char *name4, int val4,
                            char *name5, double val5, char *name6, double val6);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, int val1, char *name2, int val2,
                            char *name3, int val3);
  ...
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, int val1, char *name2, int val2,
                            char *name3, float val3, char *name4, float val4);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, int val1, char *name2, int val2,
                            char *name3, int val3, char *name4, int val4);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, int val1, char *name2, int val2);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, unsigned long val1, char *name2,
                            unsigned long val2, char *name3,
                            unsigned long val3);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *name1, char *val1, char *name2, char *val2);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
  ...
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            ...
                            char *name3, char *val3, char *name4, char *val4);
  int prepare_result_string(RPC_SRV_RESULT result, JsonDataCommObj *pReq,
                            char *result_para_name, int result_para_value);
